...
- [Pei Gao](https://uk.linkedin.com/pub/pei-gao/36/842/3b5) Post-doctorate Researcher

- [Richard Pearson](http://www.cs.man.ac.uk/~pearsonr/) PhD Student
...
The following software has been made available either wholly or partly as a result of work on this project:- [nppca](http://inverseprobability.com/nppca/) NPPCA: Probabilistic PCA that deals with different variances associated with each element of the data.

- [chipdyno](http://inverseprobability.com/chipdyno/) CHIPDYNO: Inference of transcription factor activities from microarray data and network connectivity data.

- [chipvar](http://inverseprobability.com/chipvar/) CHIPVAR: Variational inference of transcription factor concentrations and actions on target genes from microarray data and network connectivity data.

- [mmgMOS](http://www.bioinf.manchester.ac.uk/resources/puma/mmgmos/mmgmos.html) mmgMOS: Modified multi-array gMOS algorithm for extracting uncertainties from Affymetrix slides.

- [pplr](http://www.bioinf.manchester.ac.uk/resources/puma/pplr/pplr.html) PPLR: Detecting up regulated genes by using variances and looking at the probability of a positive log ratio.

- [puma](http://www.bioinf.manchester.ac.uk/resources/puma/puma/puma.html) PUMA: A Bioconductor package that inmplements mmgMOS

- [gpsim](http://inverseprobability.com/gpsim/) GPSIM: Gaussian Process Modelling of Single Input Motif networks.
...
\[[Errata](./bibpage.cgi?keyName=Rattray:propagating06&printErrata=1)\]\[[PDF](http://bib.oxfordjournals.org/cgi/reprint/7/1/37)\]\[[Pubmed](http://www.ncbi.nlm.nih.gov/entrez/query.fcgi?cmd=Retrieve&db=PubMed&list_uids=16761363&dopt=Citation)\]\[[Google
Scholar
...
\[[Errata](./bibpage.cgi?keyName=Liu:variances06&printErrata=1)\]\[[PDF](http://bioinformatics.oxfordjournals.org/cgi/reprint/btl361v1.pdf)\]\[[Pubmed](http://www.ncbi.nlm.nih.gov/entrez/query.fcgi?cmd=Retrieve&db=PubMed&list_uids=16820429&dopt=Citation)\]\[[DOI](http://dx.doi.org/10.1093/bioinformatics/btl361)\]\[[Google
Scholar
...
\[[Software](http://www.bioconductor.org/packages/2.0/bioc/html/puma.html%20)\]\[[PDF](http://bioinformatics.oxfordjournals.org/cgi/reprint/21/18/3637)\]\[[Pubmed](http://www.ncbi.nlm.nih.gov/entrez/query.fcgi?cmd=Retrieve&db=PubMed&list_uids=16020470&dopt=Citation)\]\[[DOI](http://dx.doi.org/10.1093/bioinformatics/bti583)\]\[[Advance
...
3748--3754
\[[Software](http://staffwww.dcs.shef.ac.uk/people/N.Lawrence/nppca/%20)\]\[[PDF](http://bioinformatics.oxfordjournals.org/cgi/reprint/21/19/3748)\]\[[Pubmed](http://www.ncbi.nlm.nih.gov/entrez/query.fcgi?cmd=Retrieve&db=PubMed&list_uids=16091409&dopt=Citation)\]\[[DOI](http://dx.doi.org/10.1093/bioinformatics/bti617)\]\[[Advance
...
pp 518--526
\[[Software](http://staffwww.dcs.shef.ac.uk/people/N.Lawrence/vis/%20)\]\[[Gzipped
